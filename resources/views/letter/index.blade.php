...
@section('content')
    ...
    <h1>Data  Surat</h1>
    <br>
    <a href="{{ route('letter.create') }}" class="btn btn-success mb-4">Tambah</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm" method="Post" action="{{ route('letter.destroy', $item->id) }}">
                    @csrf
                    @method('delete')
