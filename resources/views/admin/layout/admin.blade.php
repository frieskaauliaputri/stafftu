...
<link rel="shortcut icon" href="{{ public_path('wikrama.png') }}" type="image/x-icon">
...
<link rel="stylesheet" href="{{ asset('/public/assets/admin/css/progres.css') }}">
<link rel="stylesheet" href="{{ asset('/public/assets/admin/css/card.css') }}">
    ...
    <div id="app">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <img src="{{ public_path('wikrama.png') }}"
                                class="rounded-circle mr-1">
                            <div class="d-sm-none d-lg-inline-block">Hi, Frieska Aulia</div>
                        </a>
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <a class="nav-link dropdown-toggle" href="{{ route('users.index') }}" role="button" >
                         Data User</a>
                        <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ route('users.index2') }}" role="button">
                         Data User2
                        </a>
        ...
        <footer class="main-footer">
            <div class="footer-left">
                Copyright &copy; 2023, <span><a>SMK Wikrama Bogor</a></span>
            </div>
        </footer>
    </div>
    </div>
